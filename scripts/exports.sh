...
EXPORTS_FILE_PATH=/etc/profile.d/exports.sh
...
exports() {
    ...
    echo "export EPICS_BASE=${WS_PATH}/epics-base" >> ${EXPORTS_FILE_PATH}
    echo "export EPICSPVA=${WS_PATH}/epics-base" >> ${EXPORTS_FILE_PATH}
    echo "export EPICSCA=${WS_PATH}/epics-base" >> ${EXPORTS_FILE_PATH}
    echo "export EPICS_HOST_ARCH=linux-x86_64" >> ${EXPORTS_FILE_PATH}
...
if [ -f "$EXPORTS_FILE_PATH" ]; then
    echo "$EXPORTS_FILE_PATH exists."
else
    echo "$EXPORTS_FILE_PATH does not exist."
    exports
fi
